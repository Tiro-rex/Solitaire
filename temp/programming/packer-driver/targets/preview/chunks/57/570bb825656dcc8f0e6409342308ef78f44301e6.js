    ...
    execute: function () {
      ...
      _export("Pile", Pile = (_dec = ccclass('Pile'), _dec2 = property(Node), _dec(_class = (_class2 = class Pile extends Component {
        ...
        onBeginContact(self, other) {
          ...
          this.snapcard = true; // console.log("stack-->", self.tag);
        ...
        snapCardToParent(card, len) {
          ...
          this.snapParent.addChild(card); // this.deckOfCard.removeChild(card)
...
//# sourceMappingURL=570bb825656dcc8f0e6409342308ef78f44301e6.js.map