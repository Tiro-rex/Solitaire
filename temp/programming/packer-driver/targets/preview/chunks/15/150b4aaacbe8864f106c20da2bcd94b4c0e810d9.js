    ...
    execute: function () {
      ...
      _export("Pile", Pile = (_dec = ccclass('Pile'), _dec(_class = class Pile extends Component {
        ...
        snapCardToParent(card) {
          ...
          console.log("befor2", this.node.children.length);
          this.snapParent.addChild(card);
          console.log("after1", this.node.children.length);
          console.log("after2", this.snapParent.children.length);
          (_crd && cardMove === void 0 ? (_reportPossibleCrUseOfcardMove({
            error: Error()
...
//# sourceMappingURL=150b4aaacbe8864f106c20da2bcd94b4c0e810d9.js.map