System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Prefab, instantiate, Button, math, Collider2D, Contact2DType, DCard, CARDS_ARRAY, Pile, ReaveldCard, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _crd, ccclass, property, GameScreen;
    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec(_class = (_class2 = class GameScreen extends Component {
        ...
        OnClick() {
          if (this.initiallyGeneratedCard == 52) {
            ...
            (_crd && DCard === void 0 ? (_reportPossibleCrUseOfDCard({
              error: Error()
            }), DCard) : DCard).on("fromDeck", this.removeParentFrokmdeck, this);
          }
        }
        ...
        removeParentFrokmdeck(card) {
          ...
          this.count += 1;
          this.deckSnap.getComponent(_crd && Pile === void 0 ? (_reportPossibleCrUseOfPile({
            error: Error()
          }), Pile) : Pile).snapParent.addChild(card); // this.deckSnap.addChild(card)

          (_crd && DCard === void 0 ? (_reportPossibleCrUseOfDCard({
            error: Error()
          }), DCard) : DCard).removeListener("fromDeck", this.removeParentFrokmdeck, this); // console.log("removed", card)
          //console.log("removed", card)
          // console.log("child", this.reaveldCard.removeChild(card));
        } // stackcoll() {
        //     for (let i = 0; i < 7; i++) {
        //         let cardStaks = this.defaultPlayArea(i + 1).getComponent(Collider2D)
        //         // cardStaks.on(Contact2DType.BEGIN_CONTACT, this.onBeginContact, this);
        //     }
        // }
        // onBeginContact(self: Collider2D, other: Collider2D) {
        //     this.deckSnap = self.node
        // }
        ...
        onDisable() {
          for (var i = 0; i <= 7; i++) {
            var pile = this.defaultPlayArea(i);
            var coll = pile.getComponent(Collider2D);
...
//# sourceMappingURL=086cca0cddcc89d7b263d5e49ffd946e5a7f547e.js.map