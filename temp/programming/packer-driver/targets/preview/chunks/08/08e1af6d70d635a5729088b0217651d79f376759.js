    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        start() {
          ...
          coll.on("onCollisionEnter", this.onCollisionEnter, this); // this.node.on('onCollisionEnter', this.onCollisionEnter, this);
...
//# sourceMappingURL=08e1af6d70d635a5729088b0217651d79f376759.js.map