System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Label, Vec2, Vec3, Color, cardMove, DCard, Ranks, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, ReaveldCard;
    ...
    execute: function () {
      ...
      _export("default", ReaveldCard = (_dec = ccclass('ReaveldCard'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class ReaveldCard extends Component {
        ...
        init(data) {
          ...
          this.node.on(Node.EventType.TOUCH_END, this.onTouchEnd.bind(this)); // this.MatchingAlgo(data);
        ...
        MatchingAlgo(data) {
          if (data.rank == (_crd && Ranks === void 0 ? (_reportPossibleCrUseOfRanks({
            error: Error()
          }), Ranks) : Ranks).Ace) {
            console.log("hryeh");
          } // data.sort((a, b) => {
...
//# sourceMappingURL=b996718da355e544961cd6643af86883504f3c5e.js.map