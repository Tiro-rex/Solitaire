System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Prefab, instantiate, Button, math, DCard, snapLogic, CARDS_ARRAY, Pile, ReaveldCard, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _crd, ccclass, property, GameScreen;
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec(_class = (_class2 = class GameScreen extends Component {
        ...
        removeParentFrokmdeck(card) {
          ...
          (_crd && snapLogic === void 0 ? (_reportPossibleCrUseOfsnapLogic({
            error: Error()
          }), snapLogic) : snapLogic).on("ParentforSnap", this.snapForDeck, this);
        ...
        snapForDeck(Sp) {
          ...
          (_crd && snapLogic === void 0 ? (_reportPossibleCrUseOfsnapLogic({
            error: Error()
          }), snapLogic) : snapLogic).removeListener('ParentforSnap', this.snapForDeck, this);
        }
...
//# sourceMappingURL=b9ab04c1a37215c413969cc06b7414a224bddcb6.js.map