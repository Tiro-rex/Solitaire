    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        start() {
          ...
          this.stackCollider(); // this.node.on('onCollisionEnter', this.onCollisionEnter, this);
        ...
        stackCollider() {
          for (var i = 1; i = 7; i++) {
            var stack = this.defaultPlayArea(i);
            var coll = stack.getComponent(Collider2D);
...
//# sourceMappingURL=b96561a10b8018b16f77e6daa4d88d58f280fdfa.js.map