    ...
    execute: function () {
      ...
      _export("Pile", Pile = (_dec = ccclass('Pile'), _dec(_class = class Pile extends Component {
        ...
        init(array, len, count) {
          ...
          this.node.children[len - 1].active = true;
        }

        onBeginContact(self, other) {
          if (self.tag == 1 && window.moveCard) {
            var newPos = self.node.getPosition(); // console.log("Postion collider", newPos);
...
//# sourceMappingURL=d977b5e5bcb69c7611025cce0a04d72fa1cf8113.js.map