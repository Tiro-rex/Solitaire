    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        start() {
          ...
          this.stackCollider();
          this.coll.on(Contact2DType.BEGIN_CONTACT, this.onBeginContact, this); // this.node.on('onCollisionEnter', this.onCollisionEnter, this);
        ...
        stackCollider() {
          for (var i = 1; i = 7; i++) {
            var stack = this.defaultPlayArea(i);
            this.coll = stack.getComponent(Collider2D);
          }
        }
...
//# sourceMappingURL=edf60a4bddfdcae0f074597d7b1d8d2abcbfd91e.js.map