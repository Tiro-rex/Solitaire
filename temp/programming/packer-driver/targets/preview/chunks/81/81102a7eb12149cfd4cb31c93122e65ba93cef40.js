System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Prefab, instantiate, Button, math, DCard, PosSnap, CARDS_ARRAY, Pile, ReaveldCard, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _crd, ccclass, property, GameScreen;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec13 = property(Node), _dec(_class = (_class2 = class GameScreen extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "movableParent", _descriptor12, this);
        ...
        snapCard(cardPos) {
          ...
          if (Math.floor(stackp1.x) == cardPos.cardPos.x) {
            ...
            var lentgh2 = this.stack1.children.length;
            var stacckCardavlue = this.stack1.children[lentgh2 - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
          ...
          if (Math.floor(stackp2.x) == cardPos.cardPos.x) {
            ...
            cardPos.parent.removeChild(cardPos.Child);
            var lenth2 = this.stack2.children.length;
            ...
            var _stacckCardavlue = this.stack2.children[lenth2 - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;
          ...
          if (Math.floor(stackp3.x) == cardPos.cardPos.x) {
            ...
            var _stacckCardavlue2 = this.stack3.children[_lentgh - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;
            ...
            if (_stacckCardavlue2 == _selectedCardVlaue2 + 1) {
              ...
              this.stackMove(cardPos.Child); // len = -1;
              // }
            } else {
              cardPos.parent.addChild(cardPos.Child);
            }
          ...
          if (Math.floor(stackp4.x) == cardPos.cardPos.x) {
            ...
            var _stacckCardavlue3 = this.stack4.children[_lentgh2 - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;
          ...
          if (Math.floor(stackp5.x) == cardPos.cardPos.x) {
            ...
            var _stacckCardavlue4 = this.stack5.children[_lentgh3 - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;
          ...
          if (Math.floor(stackp6.x) == cardPos.cardPos.x) {
            cardPos.parent.removeChild(cardPos.Child);
            var _len6 = cardPos.parent.children.length;
            ...
            var _stacckCardavlue5 = this.stack6.children[_lentgh4 - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;

            console.log("selected Card Value", _selectedCardVlaue5);
            console.log("StackCardValue", _stacckCardavlue5);
          ...
          if (Math.floor(stackp7.x) == cardPos.cardPos.x) {
            cardPos.parent.removeChild(cardPos.Child);
            var _len7 = cardPos.parent.children.length;
            ...
            var _selectedCardVlaue6 = cardPos.Child.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;

            var _stacckCardavlue6 = this.stack7.children[_lentgh5 - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;

            if (_stacckCardavlue6 == _selectedCardVlaue6 + 1) {
              // if (len + 1 || len == null) {
            ...
            console.log("selected Card Value", _selectedCardVlaue6);
            console.log("StackCardValue", _stacckCardavlue6); // else if (len - 1) {
        ...
        flipOperation() {
          var lenth = this.snapParent.children.length;
        ...
        generateAllCards(cardArray) {
          ...
          for (var i = 0; i < arr.length; i++) {
            ...
            card.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).init(arr[i], this.movableArray);
        ...
        writable: true,
        initializer: null
      }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, "movableParent", [_dec13], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=81102a7eb12149cfd4cb31c93122e65ba93cef40.js.map