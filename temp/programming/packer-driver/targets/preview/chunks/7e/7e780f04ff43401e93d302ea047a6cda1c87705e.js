    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        start() {
          ...
          this.stack();
          this.node.on('onCollisionEnter', this.onCollisionEnter, this); // this.node.on('onCollisionEnter', this.onCollisionEnter, this);
...
//# sourceMappingURL=7e780f04ff43401e93d302ea047a6cda1c87705e.js.map