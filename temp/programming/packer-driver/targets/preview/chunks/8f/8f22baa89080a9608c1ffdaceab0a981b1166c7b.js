      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        stacklogic(stack, num) {
          for (var i = 0; i < num; i++) {
            ...
            this.h2 = this.arrayOfCard.push(card1); // card1.getChildByName('faceDown').active = false;
            // }
          ...
          var lastCard = stack.children[stack.children.length - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
            error: Error()
          }), ReaveldCard) : ReaveldCard); // let cardLast: ReaveldCard = lastCard.getComponent(ReaveldCard);
          // if (cardLast == this.lastindex) {
...
//# sourceMappingURL=8f22baa89080a9608c1ffdaceab0a981b1166c7b.js.map