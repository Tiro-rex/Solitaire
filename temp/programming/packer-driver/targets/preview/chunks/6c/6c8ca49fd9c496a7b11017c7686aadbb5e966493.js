    ...
    execute: function () {
      ...
      _export("Pile", Pile = (_dec = ccclass('Pile'), _dec(_class = class Pile extends Component {
        ...
        onBeginContact(self, other) {
          ...
          this.cardR = other.node; // console.log("hhihihi", this.cardR.value);
        ...
        snapCardToParent(card) {
          ...
          var cardInStack = this.node.children[index - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
            error: Error()
          }), ReaveldCard) : ReaveldCard).value;

          if (value > cardInStack) {
...
//# sourceMappingURL=6c8ca49fd9c496a7b11017c7686aadbb5e966493.js.map