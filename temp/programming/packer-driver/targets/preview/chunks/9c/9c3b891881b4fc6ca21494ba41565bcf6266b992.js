      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        generateAllCards(cardArray) {
          ...
          for (var i = 0; i < arr.length; i++) {
            var card = instantiate(this.cardPrefeb); // this.reaveldCard.addChild(card);
        ...
        stacklogic(stack, num) {
          ...
          return _asyncToGenerator(function* () {
            for (var i = 0; i < num; i++) {
              ...
              yield _this.delay(200, stack.addChild(card1)); // this.h2 = this.arrayOfCard.push(card1);
            }
...
//# sourceMappingURL=9c3b891881b4fc6ca21494ba41565bcf6266b992.js.map