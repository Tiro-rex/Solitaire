        ...
        stacklogic(data) {
          ...
          return _asyncToGenerator(function* () {
            for (var i = 0; i < 7; i++) {
              ...
              var card1 = _this.arrayOfCard.splice(0, 1); // this.node.addChild(card1[0])


              yield _this.delay(200, _this.node.addChild(card1[0])); // this.h2 = this.arrayOfCard.push(card1);
              // }

              var lastCard = _this.node.children[_this.node.children.length - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
                error: Error()
...
//# sourceMappingURL=6f6dbe0f19a35f67df9462b79c345da7a2607074.js.map