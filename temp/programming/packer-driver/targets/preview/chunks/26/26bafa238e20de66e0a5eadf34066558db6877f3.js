    ...
    execute: function () {
      ...
      _export("default", ReaveldCard = (_dec = ccclass('ReaveldCard'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class ReaveldCard extends Component {
        constructor() {
          ...
          this.movableArray = [];
          this.childIndex = void 0;
          this.childrenLength = void 0;
        }
        ...
        onMoveStart(e) {
          ...
          Vec2.subtract(this.offSet, this.touchStart, this.lastPosition); // let nodePos = this.node.getPosition() as unknown as Vec2;
        ...
        moveStack(offSet) {
          var childs = this.node.getParent().children;
        ...
        onTouchEnd(p) {
          ...
          var touchEndPos = p.getUILocation();
...
//# sourceMappingURL=26bafa238e20de66e0a5eadf34066558db6877f3.js.map