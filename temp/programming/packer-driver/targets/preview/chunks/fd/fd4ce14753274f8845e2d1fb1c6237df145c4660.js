  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        defaultPlayArea() {
          this.stacklogic(this.stack1);
          this.stacklogic(this.stack2);
          this.stacklogic(this.stack3);
          this.stacklogic(this.stack4);
          this.stacklogic(this.stack5);
          this.stacklogic(this.stack6);
          this.stacklogic(this.stack7);
        }
...
//# sourceMappingURL=fd4ce14753274f8845e2d1fb1c6237df145c4660.js.map