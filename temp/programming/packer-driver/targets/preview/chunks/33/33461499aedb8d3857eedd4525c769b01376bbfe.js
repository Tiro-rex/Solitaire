    ...
    execute: function () {
      ...
      _export("default", ReaveldCard = (_dec = ccclass('ReaveldCard'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class ReaveldCard extends Component {
        ...
        init(data) {
          ...
          this.node.on(Node.EventType.MOUSE_DOWN, this.onTouchStart.bind(this)); // this.node.on(Node.EventType.TOUCH_START, this.onTouchStart.bind(this));
        ...
        onTouchEnd(e) {// this.node.setSiblingIndex(1);
        }
...
//# sourceMappingURL=33461499aedb8d3857eedd4525c769b01376bbfe.js.map