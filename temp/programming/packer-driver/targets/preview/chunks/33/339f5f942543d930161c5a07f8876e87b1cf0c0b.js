      ...
      _export("Pile", Pile = (_dec = ccclass('Pile'), _dec(_class = class Pile extends Component {
        ...
        onBeginContact(self, other) {
          if (self.tag == 1 && window.moveCard) {
            ...
            var Parent = self.node.getWorldPosition();
            this.node.addChild(other.node);
            other.node.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).onTouchEnd(Parent);
...
//# sourceMappingURL=339f5f942543d930161c5a07f8876e87b1cf0c0b.js.map