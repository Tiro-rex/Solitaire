    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        defaultPlayArea() {
          ...
          switch (stack) {
            case 1:
              this.stacklogic(this.stack1, 1);

            case 2:
              this.stacklogic(this.stack2, 2);

            case 3:
              this.stacklogic(this.stack3, 3);

            case 4:
              this.stacklogic(this.stack4, 4);

            case 5:
              this.stacklogic(this.stack5, 5);

            case 6:
              this.stacklogic(this.stack6, 6);

            case 7:
              this.stacklogic(this.stack7, 7);
          }
        }
...
//# sourceMappingURL=1aabe4032dcfe4b180eff2de66287a484e670653.js.map