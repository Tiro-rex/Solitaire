System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Label, Vec2, Vec3, Color, stackPos, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, ReaveldCard;
    ...
    execute: function () {
      ...
      _export("default", ReaveldCard = (_dec = ccclass('ReaveldCard'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class ReaveldCard extends Component {
        ...
        onTouchEnd(p) {
          ...
          this.touchEndPos = p.getUILocation();
          var nodePos = this.node.getPosition();

          if ((_crd && stackPos === void 0 ? (_reportPossibleCrUseOfstackPos({
            error: Error()
          }), stackPos) : stackPos).stack1.xr > (_crd && stackPos === void 0 ? (_reportPossibleCrUseOfstackPos({
            error: Error()
          }), stackPos) : stackPos).stack1.xl && (_crd && stackPos === void 0 ? (_reportPossibleCrUseOfstackPos({
            error: Error()
          }), stackPos) : stackPos).stack1.xr > (_crd && stackPos === void 0 ? (_reportPossibleCrUseOfstackPos({
            error: Error()
          }), stackPos) : stackPos).stack1.xl) {} // if (this.parentToCheck.toString() == 'ReavledCard') {
          //     //console.log("herere_==><")
...
//# sourceMappingURL=de94497d2e94998219402dc38c63f33a8263ce4b.js.map