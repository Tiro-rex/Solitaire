        ...
        snapCard(cardPos) {
          ...
          if (Math.floor(stackp1.x) == cardPos.cardPos.x) {
            ...
            if (stacckCardavlue == selectedCardVlaue + 1) {
              if (len + 1 || len == null) {
                this.flipOperation(); // cardPos.parent.children[len - 1].getComponent(ReaveldCard).faceDown.active = false;
                // return;
...
//# sourceMappingURL=529f08ce255ce1284644312f120a86e2d45883ca.js.map