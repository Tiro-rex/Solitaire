    ...
    execute: function () {
      ...
      _export("default", ReaveldCard = (_dec = ccclass('ReaveldCard'), _dec2 = property(Label), _dec3 = property(Label), _dec(_class = (_class2 = class ReaveldCard extends Component {
        ...
        init(data) {
          // CARDS_ARRAY.values()
          // console.log(data)
          this.cardFace.string = data.suit.h;
          this.cardRank.string = data.rank;
          this.cardNumber = data.rank;
          this.cardace = data.suit;
          console.log(this.cardFace.string); // if (this.cardFace.string == data.suit.h,data.siui) {
...
//# sourceMappingURL=474ccff23a2a3576c5f51136a14633e49bb36a0b.js.map