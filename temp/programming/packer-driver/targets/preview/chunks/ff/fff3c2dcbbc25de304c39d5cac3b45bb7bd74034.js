System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Prefab, instantiate, Button, math, Collider, PhysicsSystem2D, CARDS_ARRAY, GameManager, ReaveldCard, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _crd, ccclass, property, GameScreen;
    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        start() {
          ...
          var coll = this.stack1.getComponent(Collider);
          coll.on("onCollisionEnter", this.onBeginContact, this); // this.node.on('onCollisionEnter', this.onCollisionEnter, this);
        ...
        onBeginContact(selfCollider, otherCollider, event) {
          console.log("sjhdksjhk"); // let selfcollider = event.selfCollider;
...
//# sourceMappingURL=fff3c2dcbbc25de304c39d5cac3b45bb7bd74034.js.map