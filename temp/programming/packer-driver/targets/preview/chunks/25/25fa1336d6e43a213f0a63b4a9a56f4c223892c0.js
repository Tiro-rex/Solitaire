      ...
      _export("Pile", Pile = (_dec = ccclass('Pile'), _dec2 = property(Prefab), _dec(_class = (_class2 = class Pile extends Component {
        ...
        stacklogic(data) {
          for (var i = 0; i < 7; i++) {
            ...
            var card1 = this.arrayOfCard.splice(0, 1);
            var carsof = this.node.addChild(card1[0]);
            console.log(carsof); // await this.delay(200, this.node.addChild(card1[0]));
            // this.h2 = this.arrayOfCard.push(card1);
            // }

            var lastCard = this.node.children[this.node.children.length - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
...
//# sourceMappingURL=25fa1336d6e43a213f0a63b4a9a56f4c223892c0.js.map