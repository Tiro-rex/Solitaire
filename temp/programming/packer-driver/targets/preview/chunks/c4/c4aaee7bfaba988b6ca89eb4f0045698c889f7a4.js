    ...
    execute: function () {
      ...
      _export("default", ReaveldCard = (_dec = ccclass('ReaveldCard'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class ReaveldCard extends Component {
        ...
        onTouchEnd(p) {
          ...
          Vec2.subtract(this.offSet, (_crd && stackPos === void 0 ? (_reportPossibleCrUseOfstackPos({
            error: Error()
          }), stackPos) : stackPos).stack1, this.touchEndPos);
          var nodePos = this.node.getPosition();
          var nodenewpos = this.node.setPosition(nodePos.x - this.offSet.x, nodePos.y - this.offSet.y, 0.5);
          console.log(nodenewpos); // if (this.parentToCheck.toString() == 'ReavledCard') {
          //     //console.log("herere_==><")
...
//# sourceMappingURL=c4aaee7bfaba988b6ca89eb4f0045698c889f7a4.js.map