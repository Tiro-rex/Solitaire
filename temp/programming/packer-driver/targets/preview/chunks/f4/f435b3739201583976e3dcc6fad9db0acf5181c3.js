    ...
    execute: function () {
      ...
      _export("Pile", Pile = (_dec = ccclass('Pile'), _dec(_class = class Pile extends Component {
        ...
        snapCardToParent(card) {
          ...
          var indexforstack = this.snapParent.children.length;
          ...
          if (value + 1 == cardInStack) {
            ...
            var preParent = this.cardR.getParent();
            preParent.addChild(card);
          }

          this.snapParent.children[indexforstack - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
            error: Error()
          }), ReaveldCard) : ReaveldCard).faceDown.active = false;
          (_crd && cardMove === void 0 ? (_reportPossibleCrUseOfcardMove({
            error: Error()
...
//# sourceMappingURL=f435b3739201583976e3dcc6fad9db0acf5181c3.js.map