  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        OnClick() {
          if (this.arrayOfCard2.length != 52) {
            this.creatCard(); //this.deck.interactable = false;
          } else {
        ...
        creatCard() {
          ...
          console.log("heere-->", this.arrayOfCard2.length); //this.h = this.arrayOfCard.push(card);
        ...
        stacklogic(stack, num) {
          for (var i = 0; i < num; i++) {
            ...
            this.h = this.arrayOfCard.push(card1);
          }
...
//# sourceMappingURL=94fd5ce3f2df49017ea47c936c7acef810655ac5.js.map