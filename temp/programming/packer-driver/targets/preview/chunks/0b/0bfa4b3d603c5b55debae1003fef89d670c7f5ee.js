      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        stacklogic(stack, num) {
          for (var i = 0; i < num; i++) {
            ...
            var cardLast = card1.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard); // if (cardLast == this.lastindex) {

            cardLast; // card1.getChildByName('faceDown').active = false;
            // }
            // console.log("hey", cardLast)
          }
...
//# sourceMappingURL=0bfa4b3d603c5b55debae1003fef89d670c7f5ee.js.map