    ...
    execute: function () {
      ...
      _export("default", ReaveldCard = (_dec = ccclass('ReaveldCard'), _dec2 = property(Label), _dec3 = property(Label), _dec(_class = (_class2 = class ReaveldCard extends Component {
        ...
        onMoveStart(e) {
          ...
          console.log("heyys3 ", movsd, this.node.getPosition()); // this.node.worldPosition = this.newPosition;
        }
...
//# sourceMappingURL=efa110a3d21bc4bd5300b3eb7cb2718996a07832.js.map