System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Collider2D, PhysicsSystem2D, Contact2DType, ReaveldCard, _dec, _class, _crd, ccclass, property, Pile;
      ...
      _export("Pile", Pile = (_dec = ccclass('Pile'), _dec(_class = class Pile extends Component {
        ...
        onBeginContact(self, other) {
          if (self.tag == 1 && window.moveCard) {
            ...
            this.cardR.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).onTouchEnd(newPos);
...
//# sourceMappingURL=75b7cc72fc082b38d97b56e88e67221b25438d23.js.map