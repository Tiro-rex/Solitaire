    ...
    execute: function () {
      ...
      _export("Pile", Pile = (_dec = ccclass('Pile'), _dec(_class = class Pile extends Component {
        ...
        snapCardToParent(card) {
          ...
          var cardInStack = this.node.children[0][index - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
            error: Error()
          }), ReaveldCard) : ReaveldCard).value;
          console.log("card  ", value);
          console.log("cardStack  ", cardInStack);
...
//# sourceMappingURL=1bf7776547f65bf37712fd8ae063a8a86e51205d.js.map