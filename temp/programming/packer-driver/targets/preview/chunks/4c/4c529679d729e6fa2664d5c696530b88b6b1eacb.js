    ...
    execute: function () {
      ...
      _export("Pile", Pile = (_dec = ccclass('Pile'), _dec(_class = class Pile extends Component {
        ...
        snapCardToParent(card) {
          ...
          console.log("after 1-->", this.node.children.length);
          console.log("after 2-->", this.snapParent.children.length);
          (_crd && cardMove === void 0 ? (_reportPossibleCrUseOfcardMove({
            error: Error()
...
//# sourceMappingURL=4c529679d729e6fa2664d5c696530b88b6b1eacb.js.map