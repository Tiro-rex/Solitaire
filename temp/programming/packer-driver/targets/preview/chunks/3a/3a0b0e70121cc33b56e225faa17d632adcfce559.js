    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        creatCard() {
          ...
          card.getChildByName('faceDown').active = false;
        }
        ...
        stacklogic(stack, num) {
          for (var i = 0; i < num; i++) {
            ...
            this.lastindex = stack.children[stack.children.length - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).cardNumber;

            if (card1.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).cardNumber == this.lastindex) {
              card1.getChildByName('faceDown').active = false;
            }

            console.log("hey", card1.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).cardNumber.length);
          }

          console.log("last", this.lastindex); //console.log("array", this.h2);
        }

        fn() {
          for (var i = 1; i <= 7; i++) {
            var stack = this.defaultPlayArea(i);
...
//# sourceMappingURL=3a0b0e70121cc33b56e225faa17d632adcfce559.js.map