System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _decorator, Component, Node, Label, Vec2, Vec3, Color, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, ReaveldCard;
    ...
    execute: function () {
      ...
      _export("default", ReaveldCard = (_dec = ccclass('ReaveldCard'), _dec2 = property(Label), _dec3 = property(Label), _dec(_class = (_class2 = class ReaveldCard extends Component {
        ...
        init(data) {
          ...
          if (this.cardFace.string == 'h', 'd') {
            this.cardRank.color = new Color(255, 0, 0);
            this.cardFace.color = new Color(255, 0, 0);
          } else if (this.cardFace.string == 's', 'c') {
            this.cardRank.color = new Color(0, 0, 0);
            this.cardFace.color = new Color(0, 0, 0);
          }
        ...
        onMoveStart(e) {
          ...
          this.touchStart = movsd; // console.log("heyys3 ", movsd, this.node.getPosition());
          // this.node.worldPosition = this.newPosition;
        }

        onTouchEnd(e) {// console.log("heyys", e);
          //  this.node.worldPosition = this.newPosition;
...
//# sourceMappingURL=85583c3dfd1b45f59256d51000e958aedea0cd76.js.map