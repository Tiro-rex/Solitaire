      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec(_class = (_class2 = class GameScreen extends Component {
        ...
        snapCard(cardPos) {
          ...
          if (Math.floor(stackp1.x) == cardPos.cardPos.x) {
            ...
            var stacckCardavlue = this.stack3.children[lentgh2 - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;
            ...
            if (stacckCardavlue == selectedCardVlaue + 1) {
              if (len + 1 || len == null) {
                ...
                // return;
                this.stack1.addChild(cardPos.Child); // len = -1;
              }
            } else {
          ...
          if (Math.floor(stackp2.x) == cardPos.cardPos.x) {
            ...
            var _lentgh = this.stack2.children.length;
            var _selectedCardVlaue = cardPos.Child.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;

            var _stacckCardavlue = this.stack2.children[_lentgh - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;
            ...
            if (_stacckCardavlue == _selectedCardVlaue + 1) {
              if (_len = +1 || _len == null) {
                ...
                var selected = this.stack2.addChild(cardPos.Child); // len = -1;
              }
            } else {
              cardPos.parent.addChild(cardPos.Child);
            } // else if (len - 1) {
          ...
          if (Math.floor(stackp3.x) == cardPos.cardPos.x) {
            ...
            var _lentgh2 = this.stack3.children.length;
            var _selectedCardVlaue2 = cardPos.Child.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;

            var _stacckCardavlue2 = this.stack3.children[_lentgh2 - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;
          ...
          if (Math.floor(stackp4.x) == cardPos.cardPos.x) {
            ...
            var _lentgh3 = this.stack4.children.length;
            var _selectedCardVlaue3 = cardPos.Child.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;

            var _stacckCardavlue3 = this.stack4.children[_lentgh3 - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;
          ...
          if (Math.floor(stackp5.x) == cardPos.cardPos.x) {
            ...
            var _lentgh4 = this.stack5.children.length;
            var _selectedCardVlaue4 = cardPos.Child.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;

            var _stacckCardavlue4 = this.stack5.children[_lentgh4 - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;
          ...
          if (Math.floor(stackp6.x) == cardPos.cardPos.x) {
            ...
            var _lentgh5 = this.stack6.children.length;
            var _selectedCardVlaue5 = cardPos.Child.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;

            var _stacckCardavlue5 = this.stack6.children[_lentgh5 - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;
            ...
            if (_stacckCardavlue5 == _selectedCardVlaue5 + 1) {
              if (_len5 + 1 || _len5 == null) {
                ...
                this.stack6.addChild(cardPos.Child); // len = -1;
              }
            } else {
              cardPos.parent.addChild(cardPos.Child);
            }
          ...
          if (Math.floor(stackp7.x) == cardPos.cardPos.x) {
            ...
            var _lentgh6 = this.stack7.children.length;
            var _selectedCardVlaue6 = cardPos.Child.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;

            var _stacckCardavlue6 = this.stack7.children[_lentgh6 - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).value;

            if (_stacckCardavlue6 == _selectedCardVlaue6 + 1) {
              if (_len6 + 1) {
                if (_len6 == null) cardPos.parent.children[_len6 - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
                  error: Error()
                }), ReaveldCard) : ReaveldCard).faceDown.active = false; // return;
...
//# sourceMappingURL=765d8f2aec39f9ba397291e9b2e8911485931252.js.map