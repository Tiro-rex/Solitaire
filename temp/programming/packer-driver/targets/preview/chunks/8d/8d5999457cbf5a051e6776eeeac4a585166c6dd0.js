  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        onLaod() {
          this.stack1.on('onCollisionEnter', this.onCollisionEnter, this);
        }
        ...
        start() {
          ...
          this.stack(); // this.node.on('onCollisionEnter', this.onCollisionEnter, this);
...
//# sourceMappingURL=8d5999457cbf5a051e6776eeeac4a585166c6dd0.js.map