    ...
    execute: function () {
      ...
      _export("default", ReaveldCard = (_dec = ccclass('ReaveldCard'), _dec2 = property(Label), _dec3 = property(Label), _dec(_class = (_class2 = class ReaveldCard extends Component {
        ...
        onTouchStart(e) {
          ...
          Vec2.subtract(this.offSet, this.node.getParent().getPosition(), this.touchStart); // console.log("heyys", this.touchStart);
        }
        ...
        onMoveStart(e) {
          ...
          // this.move(e);
          // }
          var movsd = e.getUILocation();
          var nodePos = this.node.getPosition();
          console.log("heyys3 ", movsd, this.node.getPosition());
          this.node.setPosition(nodePos.x + this.offSet.x, nodePos.y + this.offSet.y, 0.5); // this.node.worldPosition = this.newPosition;
        }
        ...
        move(e) {
          ...
          var yAxis = nodePos.y - this.offSet.y;
          var zoomPercentDiff = this.zoomPercentage - 100;
          var lx = -540 + 540 * zoomPercentDiff / 100;
          var dy = 420 + 960 * zoomPercentDiff / 100;
          var uy = 1500 - 960 * zoomPercentDiff / 100;
          var rx = 1620 - 540 * zoomPercentDiff / 100;
...
//# sourceMappingURL=8e2d1ee259a81be06c12d0ebaa8e14dafed6c561.js.map