    ...
    execute: function () {
      ...
      _export("Pile", Pile = (_dec = ccclass('Pile'), _dec(_class = class Pile extends Component {
        ...
        onBeginContact(self, other) {
          ...
          console.log("ParentforSnap"); // console.log("Snaping Parent", this.snapParent);
        ...
        snapCardToParent(card) {
          ...
          var index = this.node.children.length; // this.node.children[index - 1].getComponent(ReaveldCard).faceDown.active = false;
          ...
          if (this.snapParent.children.length <= 0) {
            return;
          }
...
//# sourceMappingURL=5922275b5f805b35663897af4173f9bb3e730d28.js.map