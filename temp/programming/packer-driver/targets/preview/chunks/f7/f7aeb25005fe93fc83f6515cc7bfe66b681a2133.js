    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        defaultPlayArea() {
          if (this.stack1) {
            for (var i = 0; i < 1; i++) {
              var card1 = instantiate(this.cardPrefeb);
              card1.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
                error: Error()
              }), ReaveldCard) : ReaveldCard).init(this.arrayOfCard2[0]);
              this.arrayOfCard2.splice(0, 1);
              this.stack1.addChild(card1);
            }
          }

          if (this.stack2) {
            for (var _i = 0; _i < 2; _i++) {
              var _card = instantiate(this.cardPrefeb);

              _card.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
                error: Error()
              }), ReaveldCard) : ReaveldCard).init(this.arrayOfCard2[0]);

              this.arrayOfCard2.splice(0, 1);
              this.stack2.addChild(_card);
            }
          }

          if (this.stack3) {
            for (var _i2 = 0; _i2 < 3; _i2++) {
              var _card2 = instantiate(this.cardPrefeb);

              _card2.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
                error: Error()
              }), ReaveldCard) : ReaveldCard).init(this.arrayOfCard2[0]);

              this.arrayOfCard2.splice(0, 1);
              this.stack3.addChild(_card2);
            }
          }

          if (this.stack4) {
            for (var _i3 = 0; _i3 < 4; _i3++) {
              var _card3 = instantiate(this.cardPrefeb);

              _card3.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
                error: Error()
              }), ReaveldCard) : ReaveldCard).init(this.arrayOfCard2[0]);

              this.arrayOfCard2.splice(0, 1);
              this.stack4.addChild(_card3);
            }
          }

          if (this.stack5) {
            for (var _i4 = 0; _i4 < 5; _i4++) {
              var _card4 = instantiate(this.cardPrefeb);

              _card4.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
                error: Error()
              }), ReaveldCard) : ReaveldCard).init(this.arrayOfCard2[0]);

              this.arrayOfCard2.splice(0, 1);
              this.stack5.addChild(_card4);
            }
          }

          if (this.stack6) {
            for (var _i5 = 0; _i5 < 6; _i5++) {
              var _card5 = instantiate(this.cardPrefeb);

              _card5.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
                error: Error()
              }), ReaveldCard) : ReaveldCard).init(this.arrayOfCard2[0]);

              this.arrayOfCard2.splice(0, 1);
              this.stack6.addChild(_card5);
            }
          }

          if (this.stack7) {
            for (var _i6 = 0; _i6 < 7; _i6++) {
              var _card6 = instantiate(this.cardPrefeb);

              _card6.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
                error: Error()
              }), ReaveldCard) : ReaveldCard).init(this.arrayOfCard2[0]);

              this.arrayOfCard2.splice(0, 1);
              this.stack7.addChild(_card6);
            }
          }
        }
...
//# sourceMappingURL=f7aeb25005fe93fc83f6515cc7bfe66b681a2133.js.map