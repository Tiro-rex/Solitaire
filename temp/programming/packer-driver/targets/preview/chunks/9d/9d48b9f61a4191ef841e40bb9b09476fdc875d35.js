    ...
    execute: function () {
      ...
      _export("Pile", Pile = (_dec = ccclass('Pile'), _dec(_class = class Pile extends Component {
        ...
        start() {
          ...
          coll.on(Contact2DType.END_CONTACT, this.onBeginContact, this); // this.cardR.getComponent(ReaveldCard)
        }
...
//# sourceMappingURL=9d48b9f61a4191ef841e40bb9b09476fdc875d35.js.map