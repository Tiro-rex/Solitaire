      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec(_class = (_class2 = class GameScreen extends Component {
        ...
        snapCard(cardPos) {
          ...
          if (Math.floor(stackp1.x) == cardPos.cardPos.x) {
            cardPos.parent.removeChild(cardPos.Child); // let len = cardPos.parent.children.length
            ...
            if (stacckCardavlue == selectedCardVlaue + 1) {
              this.stack1.addChild(cardPos.Child); // cardPos.parent.children[len - 1].getComponent(ReaveldCard).faceDown.active = false;
              // return;
              // len = -1;
            } else {
          ...
          if (Math.floor(stackp7.x) == cardPos.cardPos.x) {
            ...
            if (_stacckCardavlue6 == _selectedCardVlaue6 + 1) {
              if (_len5 + 1) {
                if (_len5 == null) cardPos.parent.children[_len5 - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
                  error: Error()
                }), ReaveldCard) : ReaveldCard).faceDown.active = false; // return;
        ...
        flipOperation() {
          var lenth = this.snapParent.children.length; // console.log("herhehr=>>>>", lenth);
...
//# sourceMappingURL=5b3ea84b1ab40fb72812e205f0e084e80ce04b1a.js.map