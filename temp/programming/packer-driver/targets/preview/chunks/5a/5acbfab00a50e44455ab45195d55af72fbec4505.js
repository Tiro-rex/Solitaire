        ...
        randCardGenrate() {
          for (var [_Suits, _Color] of s52SuitsColors) {
            for (var rank of s52Ranks) {
              var card = this.getComponent(_crd && GameScreen === void 0 ? (_reportPossibleCrUseOfGameScreen({
                error: Error()
              }), GameScreen) : GameScreen);
              var color = this.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
                error: Error()
...
//# sourceMappingURL=5acbfab00a50e44455ab45195d55af72fbec4505.js.map