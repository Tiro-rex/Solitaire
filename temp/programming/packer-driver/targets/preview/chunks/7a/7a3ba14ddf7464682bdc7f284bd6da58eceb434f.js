System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Label, Vec2, Vec3, Color, cardMove, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, ReaveldCard;
    ...
    execute: function () {
      ...
      _export("default", ReaveldCard = (_dec = ccclass('ReaveldCard'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class ReaveldCard extends Component {
        ...
        onMoveStart(e) {
          ...
          window.moveCard = true; //console.log("heyys3 ", this.node.getPosition());
        ...
        onTouchEnd(p) {
          (_crd && cardMove === void 0 ? (_reportPossibleCrUseOfcardMove({
            error: Error()
          }), cardMove) : cardMove).emit("snapCard", this.node); // this.node.setSiblingIndex(1);
        }
...
//# sourceMappingURL=7a3ba14ddf7464682bdc7f284bd6da58eceb434f.js.map