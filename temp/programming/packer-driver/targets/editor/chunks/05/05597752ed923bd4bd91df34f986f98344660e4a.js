    ...
    execute: function () {
      ...
      _export("Pile", Pile = (_dec = ccclass('Pile'), _dec(_class = class Pile extends Component {
        ...
        snapCardToParent(card) {
          ...
          if (value == cardInStack || value == 1 && cardInStack == null) {
            if (value == cardInStack + 1) {
          ...
          this.snapParent.children[index - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
            error: Error()
          }), ReaveldCard) : ReaveldCard).faceDown.active = false;
        }
...
//# sourceMappingURL=05597752ed923bd4bd91df34f986f98344660e4a.js.map