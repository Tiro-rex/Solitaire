    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        start() {
          ...
          this.generateAllCards(_crd && CARDS_ARRAY === void 0 ? (_reportPossibleCrUseOfCARDS_ARRAY({
            error: Error()
          }), CARDS_ARRAY) : CARDS_ARRAY);
        ...
        generateAllCards(cardArray) {
          ...
          for (let i = 0; i < arr.length; i++) {
            let card = instantiate(this.cardPrefeb); // this.reaveldCard.addChild(card);

            card.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).init(arr[i]); // this.arrayOfCard2.splice(0, 1);

            this.arrayCards.push(card); // console.log("Array", this.h);
            // card.getComponent(ReaveldCard).faceDown.active = false;
          }
        }
        ...
        async stacklogic(stack, num) {
          for (let i = 0; i < num; i++) {
            ...
            this.arrayOfCard2.splice(0, 1);
            await this.delay(200, stack.addChild(card1)); // this.h2 = this.arrayOfCard.push(card1);
          }
          ...
          lastCard.faceDown.active = false; // lastCard.faceUp.active = true;
...
//# sourceMappingURL=b98bd08baf6b3751270e2bf131e548e39e50bb74.js.map