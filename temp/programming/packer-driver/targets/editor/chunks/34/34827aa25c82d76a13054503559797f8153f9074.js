System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Label, Vec2, Vec3, Color, GameScreen, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, ReaveldCard;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      GameScreen = _unresolved_2.GameScreen;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("default", ReaveldCard = (_dec = ccclass('ReaveldCard'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(_crd && GameScreen === void 0 ? (_reportPossibleCrUseOfGameScreen({
        error: Error()
      }), GameScreen) : GameScreen), _dec(_class = (_class2 = class ReaveldCard extends Component {
        constructor(...args) {
          super(...args);
        ...
        init(data) {
          console.log(this.game.Shuffel(data.suit));
...
//# sourceMappingURL=34827aa25c82d76a13054503559797f8153f9074.js.map