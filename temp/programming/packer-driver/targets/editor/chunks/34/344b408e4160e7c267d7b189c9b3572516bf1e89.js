System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Prefab, instantiate, Button, CARDS_ARRAY, GameManager, PileMaxFanOperation, ReaveldCard, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, Pile;
    ...
    execute: function () {
      ...
      _export("Pile", Pile = (_dec = ccclass('Pile'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        set maxFan(maxFan) {
          ...
          const op = new (_crd && PileMaxFanOperation === void 0 ? (_reportPossibleCrUseOfPileMaxFanOperation({
            error: Error()
...
//# sourceMappingURL=344b408e4160e7c267d7b189c9b3572516bf1e89.js.map