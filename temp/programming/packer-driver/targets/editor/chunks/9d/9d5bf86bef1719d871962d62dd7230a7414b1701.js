    ...
    execute: function () {
      ...
      _export("default", ReaveldCard = (_dec = ccclass('ReaveldCard'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class ReaveldCard extends Component {
        ...
        init(data) {
          ...
          this.cardRank2.string = data.rank; // this.cardNumber = data.rank;
          ...
          this.rankValue(data); // console.log('s', data.rank)
        }
        ...
        rankValue(data) {
          this.suitofCard = data.suit.toString();

          if (this.cardRank.string == "A") {
            this.value = 1;
          }

          if (this.cardRank.string == "2") {
            this.value = 2;
          }

          if (this.cardRank.string == "3") {
            this.value = 3;
          }

          if (this.cardRank.string == "4") {
            this.value = 4;
          }

          if (this.cardRank.string == "5") {
            this.value = 5;
          }

          if (this.cardRank.string == "6") {
            this.value = 6;
          }

          if (this.cardRank.string == "7") {
            this.value = 7;
          }

          if (this.cardRank.string == "8") {
            this.value = 8;
          }

          if (this.cardRank.string == "9") {
            this.value = 9;
          }

          if (this.cardRank.string == "10") {
            this.value = 10;
          }

          if (this.cardRank.string == "J") {
            this.value = 11;
          }

          if (this.cardRank.string == "Q") {
            this.value = 12;
          }

          if (this.cardRank.string == "K") {
            this.value = 13;
          }
        }
...
//# sourceMappingURL=9d5bf86bef1719d871962d62dd7230a7414b1701.js.map