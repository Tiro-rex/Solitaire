System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Prefab, instantiate, CARDS_ARRAY, ReaveldCard, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, GameScreen;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = class GameScreen extends Component {
        constructor(...args) {
          super(...args);
        ...
        OnClick() {
          ...
          if (this.h == 52) {} // this.getComponent(Card).init();
...
//# sourceMappingURL=8f37c756f59e2d3a4558b0944f60309a07531c4e.js.map