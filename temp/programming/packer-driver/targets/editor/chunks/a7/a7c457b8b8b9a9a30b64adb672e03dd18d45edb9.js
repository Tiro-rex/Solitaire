System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Prefab, instantiate, Deck, CARDS_ARRAY, ReaveldCard, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, GameScreen;
  ...
  function _reportPossibleCrUseOfDeck(extras) {
    _reporterNs.report("Deck", "../../node_modules/klondike-solitaire/src/layout/Deck", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec(_class = (_class2 = class GameScreen extends Component {
        ...
        OnLoad() {
          (_crd && Deck === void 0 ? (_reportPossibleCrUseOfDeck({
            error: Error()
          }), Deck) : Deck).make();
        }
        ...
        OnClick() {
          this.getDeckOfCard(); // this.getComponent(Card).init();
        }

        getDeckOfCard() {
          //console.log("dhoom dhoom");
          // for (let i = 0; i < ; i++) {
          let card = instantiate(this.cardPrefeb); //card.getComponent(Card).randCardGenrate();
          ...
          this.arrayOfCard2.splice(0, 1); // this.h = this.arrayOfCard.push(card);
...
//# sourceMappingURL=a7c457b8b8b9a9a30b64adb672e03dd18d45edb9.js.map