    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        creatCard() {
          ...
          console.log("Array", this.h); // card.getComponent(ReaveldCard).faceDown.active = false;
        }
        ...
        generateCard() {
          ...
          this.arrayOfCard2.splice(0, 1);
          this.arrayOfCard.push(card1); // await this.delay(200, stack.addChild(card1));
        }
...
//# sourceMappingURL=60b230f22ee08420af891f554efa6d05d49801bd.js.map