System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Prefab, instantiate, Button, math, CARDS_ARRAY, GameManager, Pile, ReaveldCard, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _crd, ccclass, property, GameScreen;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(Node), _dec6 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        error: Error()
      }), GameManager) : GameManager), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec13 = property(Node), _dec14 = property(Node), _dec(_class = (_class2 = class GameScreen extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "mainArea", _descriptor6, this);

          _initializerDefineProperty(this, "stack1", _descriptor7, this);

          _initializerDefineProperty(this, "stack2", _descriptor8, this);

          _initializerDefineProperty(this, "stack3", _descriptor9, this);

          _initializerDefineProperty(this, "stack4", _descriptor10, this);

          _initializerDefineProperty(this, "stack5", _descriptor11, this);

          _initializerDefineProperty(this, "stack6", _descriptor12, this);

          _initializerDefineProperty(this, "stack7", _descriptor13, this);
        ...
        OnResetDeck(cardArray) {
          for (let i = 0; i < this.h; i++) {
            let resetCard = cardArray[this.count[i]];
            this.resetdeckButton.addChild(resetCard);
          }
        }
        ...
        initilizeStack() {
          ...
          for (let i = 1; i <= 7; i++) {
            this.count += i;
            let stack = this.defaultPlayArea(i).getComponent(_crd && Pile === void 0 ? (_reportPossibleCrUseOfPile({
              error: Error()
            }), Pile) : Pile);
        ...
        writable: true,
        initializer: null
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "game", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "mainArea", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "stack1", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "stack2", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "stack3", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "stack4", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, "stack5", [_dec12], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, "stack6", [_dec13], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, "stack7", [_dec14], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=26abbc3ca69b8f24dfc4795e054f29c447a640a6.js.map