    ...
    execute: function () {
      ...
      _export("Pile", Pile = (_dec = ccclass('Pile'), _dec(_class = class Pile extends Component {
        ...
        snapCardToParent(card, len) {
          ...
          let lastindex = this.snapParent.children.findIndex(card, -1);
          console.error("hereris the LastIndex", lastindex);
...
//# sourceMappingURL=6a59d7cf908912df7b442acb39f7b26d7bca3361.js.map