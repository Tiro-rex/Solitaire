System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Label, Vec2, Vec3, Color, cardMove, deckCard, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, ReaveldCard;
  ...
  function _reportPossibleCrUseOfdeckCard(extras) {
    _reporterNs.report("deckCard", "./GameConstant", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      deckCard = _unresolved_2.deckCard;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("default", ReaveldCard = (_dec = ccclass('ReaveldCard'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class ReaveldCard extends Component {
        ...
        onTouchStart(e) {
          ...
          console.log("sdsdsdsdsds--s=ds-dss", this.parentToCheck);
        }
        ...
        onTouchEnd(p) {
          ...
          if (this.node.parent) (_crd && deckCard === void 0 ? (_reportPossibleCrUseOfdeckCard({
            error: Error()
          }), deckCard) : deckCard).emit("fromDeck", this.node);
...
//# sourceMappingURL=934131a0db37eea7e649fe952e1be5e612481bfb.js.map