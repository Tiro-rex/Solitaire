  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec(_class = (_class2 = class GameScreen extends Component {
        ...
        snapCard(cardPos) {
          console.log("herehr", cardPos.Child);
          let stackp1 = this.stack1.getPosition();
          let stack2 = this.stack2.getPosition();
          let stack3 = this.stack3.getPosition();
          let stack4 = this.stack4.getPosition();
          let stack5 = this.stack5.getPosition();
          let stack6 = this.stack6.getPosition();
          let stack7 = this.stack7.getPosition();

          if (stackp1.x == cardPos.cardPos.x) {
            console.log("nowHEWEs");
            cardPos.Child.getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
              error: Error()
            }), ReaveldCard) : ReaveldCard).removeFromParent();
...
//# sourceMappingURL=933a7354b0616d19dd8370c83ec7d42f9c62dae2.js.map