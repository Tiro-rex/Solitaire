        ...
        snapCard(cardPos) {
          ...
          if (Math.floor(stackp2.x) == cardPos.cardPos.x) {
            ...
            if (len + 1 || len == 0) {
              ...
              cardPos.parent.children[len - 0].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
                error: Error()
              }), ReaveldCard) : ReaveldCard).faceDown.active = false;
            } else {
...
//# sourceMappingURL=0f627972f6fb9e42d5dbd91932c95d4e517b1004.js.map