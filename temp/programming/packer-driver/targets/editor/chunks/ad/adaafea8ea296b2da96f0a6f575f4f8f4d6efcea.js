System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Prefab, instantiate, Button, math, cardMove, CARDS_ARRAY, Pile, ReaveldCard, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _crd, ccclass, property, GameScreen;
    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec13 = property(Node), _dec(_class = (_class2 = class GameScreen extends Component {
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "pile", _descriptor5, this);
        ...
        deckCard(cardArray) {
          ...
          (_crd && cardMove === void 0 ? (_reportPossibleCrUseOfcardMove({
            error: Error()
          }), cardMove) : cardMove).on("snapCard", this.removeParentFrokmdeck, this);
        }

        removeParentFrokmdeck(card) {
          console.log("removed"); // this.reaveldCard.removeChild(card);
          // console.log("child", this.reaveldCard.removeChild(card));
          // cardMove.removeListener("snapCard", this.removeParentFrokmdeck, this)

          this.pile.snapCardToParent(card);
        }
        ...
        writable: true,
        initializer: null
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "pile", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=adaafea8ea296b2da96f0a6f575f4f8f4d6efcea.js.map