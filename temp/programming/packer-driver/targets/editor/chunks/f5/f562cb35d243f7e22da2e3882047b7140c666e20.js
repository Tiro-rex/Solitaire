      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec(_class = (_class2 = class GameScreen extends Component {
        ...
        deckCard(cardArray) {
          ...
          (_crd && cardMove === void 0 ? (_reportPossibleCrUseOfcardMove({
            error: Error()
          }), cardMove) : cardMove).on("snapCard", this.reaveldCard.removeChild(card), this);
          card.getComponent(_crd && Pile === void 0 ? (_reportPossibleCrUseOfPile({
            error: Error()
          }), Pile) : Pile).snapCardToParent(card);
        }

        removeParentFrokmdeck(card) {
          console.log("removed"); //cardMove.removeListener("snapCard", this.removeParentFrokmdeck, this)
        }
...
//# sourceMappingURL=f562cb35d243f7e22da2e3882047b7140c666e20.js.map