    ...
    execute: function () {
      ...
      _export("Pile", Pile = (_dec = ccclass('Pile'), _dec(_class = class Pile extends Component {
        ...
        snapCardToParent(card) {
          ...
          let index = this.node.children.length; // this.node.children[index - 1].getComponent(ReaveldCard).faceDown.active = false;
...
//# sourceMappingURL=e6ed8a93774dd62ac2d39084a6cf4e37a72616c8.js.map