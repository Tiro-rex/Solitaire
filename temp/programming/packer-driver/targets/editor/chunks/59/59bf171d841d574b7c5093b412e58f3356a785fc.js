  ...
  return {
    ...
    execute: function () {
      ...
      _export("Pile", Pile = (_dec = ccclass('Pile'), _dec2 = property(Prefab), _dec(_class = (_class2 = class Pile extends Component {
        ...
        async stacklogic(data) {
          for (let i = 0; i < 7; i++) {
            // let card1 = instantiate(this.cardPrefeb);
            // card1.getComponent(ReaveldCard).init(this.arrayOfCard[0]);
            let card1 = this.arrayOfCard.splice(0, 1); // this.node.addChild(card1[0])

            await this.delay(200, this.node.addChild(card1[0])); // this.h2 = this.arrayOfCard.push(card1);
            // }
...
//# sourceMappingURL=59bf171d841d574b7c5093b412e58f3356a785fc.js.map