      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec(_class = (_class2 = class GameScreen extends Component {
        ...
        removeParentFrokmdeck(card) {
          ...
          (_crd && snapParent === void 0 ? (_reportPossibleCrUseOfsnapParent({
            error: Error()
          }), snapParent) : snapParent).on("ParentforSnap", this.snapForDeck, this);
        ...
        snapForDeck(sp) {
          console.log("gameScreenEvent");
          let value = this.reaveldCard.children[1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
            error: Error()
          }), ReaveldCard) : ReaveldCard).value;
          console.log("deck value", value); // if(){
          // }

          sp.sp.addChild(sp.c);
          (_crd && snapParent === void 0 ? (_reportPossibleCrUseOfsnapParent({
            error: Error()
          }), snapParent) : snapParent).removeListener('ParentforSnap', this.snapForDeck, this);
        }
...
//# sourceMappingURL=e7db2b3300ae58931045e9e0fd11323be30fe217.js.map