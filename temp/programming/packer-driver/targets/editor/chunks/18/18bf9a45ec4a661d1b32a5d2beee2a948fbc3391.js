        ...
        snapCard(cardPos) {
          ...
          if (Math.floor(stackp2.x) == cardPos.cardPos.x) {
            ...
            if (len + 1 || len == 0) {
              ...
              cardPos.parent.children[len - 2].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
                error: Error()
              }), ReaveldCard) : ReaveldCard).faceDown.active = false;
            } else {
...
//# sourceMappingURL=18bf9a45ec4a661d1b32a5d2beee2a948fbc3391.js.map