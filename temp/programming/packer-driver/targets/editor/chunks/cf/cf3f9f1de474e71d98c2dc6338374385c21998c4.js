    ...
    execute: function () {
      ...
      _export("Pile", Pile = (_dec = ccclass('Pile'), _dec(_class = class Pile extends Component {
        ...
        snapCardToParent(card) {
          ...
          let cardInStack = this.node.children[0][index - 1].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
            error: Error()
          }), ReaveldCard) : ReaveldCard).value;
          console.log("card  ", value);
...
//# sourceMappingURL=cf3f9f1de474e71d98c2dc6338374385c21998c4.js.map