        ...
        snapCard(cardPos) {
          ...
          if (Math.floor(stackp2.x) == cardPos.cardPos.x) {
            ...
            if (len + 1 || len == 0) {
              ...
              cardPos.parent.children[len].getComponent(_crd && ReaveldCard === void 0 ? (_reportPossibleCrUseOfReaveldCard({
                error: Error()
              }), ReaveldCard) : ReaveldCard).faceDown.active = false;
            } else {
...
//# sourceMappingURL=3f9dacfe8d81f3b6fa634a47c4df334dfbbee0b0.js.map