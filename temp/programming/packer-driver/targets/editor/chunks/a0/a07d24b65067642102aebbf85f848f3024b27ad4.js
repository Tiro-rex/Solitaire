    ...
    execute: function () {
      ...
      _export("default", ReaveldCard = (_dec = ccclass('ReaveldCard'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class ReaveldCard extends Component {
        ...
        onTouchStart(e) {
          ...
          console.log("Parent", this.node.getParent().name); // this.game.onCollisionEnter(this.node);
        }
        ...
        onTouchEnd(pos) {
          window.moveCard = false; // this.node.setPosition(pos);

          let lastPos = this.node.getParent().getPosition(); //this.node.setSiblingIndex();

          this.node.setPosition(lastPos); // console.log("Position", this.node.worldPosition);
        }
...
//# sourceMappingURL=a07d24b65067642102aebbf85f848f3024b27ad4.js.map