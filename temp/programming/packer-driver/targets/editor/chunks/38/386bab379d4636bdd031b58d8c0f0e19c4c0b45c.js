System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Collider2D, PhysicsSystem2D, Contact2DType, cardMove, Ranks, ReaveldCard, _dec, _class, _crd, ccclass, property, Pile;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Pile", Pile = (_dec = ccclass('Pile'), _dec(_class = class Pile extends Component {
        ...
        start() {
          this.offCard = _crd && Ranks === void 0 ? (_reportPossibleCrUseOfRanks({
            error: Error()
          }), Ranks) : Ranks;
        ...
        backtoParent(card) {} //Algo


        SortAlgo(card) {
          let rank = [...(_crd && Ranks === void 0 ? (_reportPossibleCrUseOfRanks({
            error: Error()
          }), Ranks) : Ranks)];
...
//# sourceMappingURL=386bab379d4636bdd031b58d8c0f0e19c4c0b45c.js.map