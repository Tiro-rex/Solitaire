    ...
    execute: function () {
      ...
      _export("GameScreen", GameScreen = (_dec = ccclass('GameScreen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec(_class = (_class2 = class GameScreen extends Component {
        ...
        getDeckOfCard() {
          ...
          for (let i = 0; i < 1; i++) {
            if (this.cardPrefeb[i].length > 3) {
              return;
            }

            this.arrayOfCard[i] = instantiate(this.cardPrefeb);
            this.reaveldCard.addChild(this.arrayOfCard[i]);
          }
        } //}
...
//# sourceMappingURL=dd9fbceefa033f1caa9b359518a6ab227863521e.js.map